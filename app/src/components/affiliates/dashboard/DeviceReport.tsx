    ...
    return (
        ...
        <div className="rounded-2xl bg-white px-2 py-5 shadow-sm md:px-5">
            ...
            {reportInfo.map((report, index) => {
                return (
                    <div className={"flex items-center justify-between" + (index == 2 ? "": " mb-7")} key={report.title}>
                        <div className="flex items-center justify-center">
                            <div className="h-10 w-10 ">
                                <DoughnutChart value={report.percentValue} color={report.color}/>
                            </div>
                            ...
                            <div className="ml-1 text-base text-[#04B042]">{report.increaseValue}%</div>
                        </div>
                        <div className="text-base font-bold text-black">{report.amount}</div>
                    </div>
                );
            })}
